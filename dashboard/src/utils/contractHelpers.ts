...
import y5Abi from 'config/abi/y5.json'
...
export const getY5Contract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(y5Abi, tokens.y5.address, signer)
}
