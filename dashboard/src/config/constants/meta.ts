...
export const DEFAULT_META: PageMeta = {
  title: 'Y-5 Finance',
  description:
    'The current reflections will be in Evergrow, Reflecto, Crypter, Rematic and, BUSD... You will then also earn rewards off Evergrow, Reflecto, Rematic and Crypter. We will launch the custom reflections feature in Q2 2022, this will allow token holders to choose up to 5 tokens they wish to get reflections in... meaning Y-5 will never go out of fashion and always stay relevant and reflect in what is hot.',
  image: 'https://y-5dashboard.finance/images/hero.png',
}
